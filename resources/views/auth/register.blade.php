...
<div class="container">
    ...
    <div class="row ">
      <div class="col s12 m8 l6 xl16 offset-m2 offset-l3 offset-xl3">
        <blockquote>
            ...
            <div class="card horizontal">
              ...
              <div class="card-stacked">
                <div class="card-content">
                  <div class="row">
                    <form class="col s12 m12 l12 xl12" method="POST" action="{{ route('register') }}" aria-label="{{ __('Register') }}">
                        @csrf
                        <div class="row">
                          ...
                          <div class="input-field col s12 m12 l10 xl10 offset-l1 offset-xl1">
                            <input autocomplete="off" id="email" type="email" class="validate{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required>
                          ...
                          <div class="input-field col s12 m12 l10 xl10 offset-l1 offset-xl1">
                            <input autocomplete="off" id="phone" type="text" class="validate{{ $errors->has('phone') ? ' is-invalid' : '' }}" name="phone" required>
